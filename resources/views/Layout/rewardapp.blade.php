    ...
    <nav class="bg-gradient-to-r from-birumuda to-krem shadow-lg fixed top-0 w-full h-18 z-50">
        <div class="container mx-auto flex items-center justify-between py-4 px-6 md:px-10">
            ...
            <ul class="hidden lg:flex items-center space-x-6 font-medium text-gray-700">
                <li><a href="{{ route('dashboard.nasabah') }}" class="text-gray-700 rounded-lg inline-flex justify-center w-full px-4 py-2">Beranda</a></li>
                ...
                <li><a href="{{ route('nasabah.rewards') }}" class="text-white bg-green-700 rounded-lg hover:bg-old-hulk inline-flex justify-center w-full px-4 py-2">Reward</a></li>
            </ul>
            ...
            <ul id="mobileDropdownMenu" class="lg:hidden hidden flex-col px-4 items-center space-y-4 bg-white border-t border-gray-200 py-4 font-medium text-gray-700">
                ...
                <li><a href="{{ route('nasabah.rewards') }}" class="hover:text-hulk">Reward</a></li>
